/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7b1fe4383e81190a24853758871fd98)
// Runtime types generated with workerd@1.20260722.1 2026-07-24 
interface __BaseEnv_Env {
	WAKE_QUEUE: Queue;
	ASSETS: Fetcher;
	ORCH_ORGANIZATION_SLUG: "staging";
	ORCH_ORGANIZATION_NAME: "UGC Orchestrator Staging";
	ORCH_RUNNER_SUBJECT: "service|cloudflare-runner";
	ORCH_APP_ORIGIN: "https://staging.ugc-orchestrator.example";
	API_CONTAINER: DurableObjectNamespace<import("./src/index").ApiContainer>;
	RUNNER_CONTAINER: DurableObjectNamespace<import("./src/index").RunnerContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ApiContainer" | "RunnerContainer";
	}

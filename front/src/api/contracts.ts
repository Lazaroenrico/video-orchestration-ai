// Public HTTP/SSE contracts consumed by the frontend. Keep this file frontend-owned:
// sync changes from the backend OpenAPI/API docs, never by importing backend code.
